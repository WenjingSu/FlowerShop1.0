...
<html>
  ...
  <table class="list-style Interlaced">
   <tr>
    ...
    <td class="center">${user.u_name}</td>
    ...
    <td class="center">${user.u_birthday}</td>
    <td class="center">${user.u_phone}</td>
    <td class="center">${user.u_info}</td>
    <td class="center">
     <a href="<%=path%>/UsersServlet?method=userfindbyuId1&u_id=${user.u_id}">查看</a>
    </td>
  ...
  <div style="overflow:hidden;">
	  ...
	  <div class="turnPage center fr">
	   <a href="<%=path%>/UsersServlet?method=userfindall">返回</a>
	  </div>
  </div>
 </div>
  </body>
