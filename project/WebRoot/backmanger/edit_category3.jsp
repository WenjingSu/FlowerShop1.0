...
<script type="text/javascript">
        ...
        var fgt_id = $("#fgt_id").val();  
   		...
   		var btn1span = $("#btn1span").val();
			if (gt_typename!=""&&gt_typename!=null&&gt_typename.indexOf(" ")==-1) {
				$.post("GoodsTypeServlet",{method:"goodstypeAddChildren",gt_typename:gt_typename,gt_mark:gt_mark,fgt_id:fgt_id},function(data){
					var num = data;
					if (num==1) {
					    alert("添加成功");
  ...
  <div class="page-title">
   ...
   <input type="hidden" id="fgt_id" value="${g_id}">
