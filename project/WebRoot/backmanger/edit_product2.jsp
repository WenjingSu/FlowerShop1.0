...
<html>
  ...
  <script type="text/javascript">
    $(function(){
         var typename ="${goodstype.gt_typename}";
         var flowernum="${flowernum.floNum_name}";
         $("#gt_typename").html(typename);
         $("#flowernum").html(flowernum);
     }); 
    $(function () {
		$("#btn1").click(function(){    
		var g_id=$("#g_id").val();
		...
		var g_info = $("#g_info").val();
			...
			&&g_info!=""&&g_info!=null) {
				$.post("GoodsServlet",{method:"update_product",g_id:g_id,g_name:g_name,gt_id:gt_id,floNum_id:floNum_id
  ...
  <div class="page-title">
    <span class="modular fl"><i class="add"></i><em>编辑产品基本信息</em></span>
  ...
  <tr>
    ...
    <td><input type="text" id="g_name" class="textBox length-long" name="g_name" value="${good.g_name}"/></td>
  </tr>
    ...
    <td>
     <select class="textBox" id="gt_id" name="gt_id">
 		<c:forEach items="${goodstypes}" var="goodstypes">
 		     ...
 		     <option id="gt_typename" value="${goodstypes.gt_id}" name="gt_id">${goodstypes.gt_typename}</option>
 		 </c:forEach>
 		</c:forEach>
     </select>
    </td>
    ...
    <td>
     <select class="textBox" id="floNum_id" name="floNum_id"  >
 		<c:forEach items="${flowerNums}" var="flowerNums">
 		  <option id="flowernum" value="${flowerNums.floNum_id}"  value="flowerNums.floNum_name" name="floNum_id">${flowerNums.floNum_name}</option>
 		</c:forEach>
  ...
  <tr>
    ...
    <td>
     <input type="text" id="purchasing_price" value="${good.purchasing_price}" class="textBox length-short" name="purchasing_price" />
     <span>元</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
     <input type="text" id="original_price" value="${good.original_price}" class="textBox length-short" name="original_price"/>
     <span>元</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
     <input type="text" id="goods_price" value="${good.goods_price}" class="textBox length-short" name="goods_price"/>
     <span>元</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
     <input type="text" id="amount" value="${good.amount}" class="textBox length-short" name="amount"/>
     <span>个</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" id="g_info" value="${good.g_info}" class="textBox length-long" name="g_info"/></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="submit" value="提交" id="btn1" class="tdBtn"/></td>
  </tr>
 </table>
