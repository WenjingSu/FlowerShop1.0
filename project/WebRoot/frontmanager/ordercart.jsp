		...
		<div class="container">
			<div class="checkout-box">
				...
				<form id="checkoutForm"
					action="${pageContext.request.contextPath}/AddressServlet?method=addorderlistcart"
					method="post">
								...
								<div class="box-bd">
									<dl class="checkout-goods-list">
										...
										<dd class="item clearfix">
											...
											<c:forEach items="${listgood}" var="listgood">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
													...
													<div class="col col-3">${listgood.goods_amount}</div>
													<div class="col col-4" id="totalprice">${listgood.goods_price*listgood.goods_amount}元</div>
												</div>
