...
<script type="text/javascript">							
								$(function(){
									...
									$("#tel1").blur(function (){		
										...
										$.post("UserFrontServlet",{method:"userPhoneFindbyName",tel1:tel1},function(data){
											...
											if (num==1&&tel1!=""&&tel1!=null&&re1.test(tel1)) {
												...
												$("#tel1span").html("<img src='' style='width: 15px'/>该手机号已被注册");
									...
									$("#tel1").keyup(function(){
										...
										var tel1 = $("#tel1").val();
										if (re1.test(tel1)) {
											$("#tel1span").html("<img src='' style='width: 15px'/>");
										} else{
											$("#tel1span").html("<img src='' style='width: 15px'/>请输入正确的11位手机号");
											$("#register1").attr("disabled","disabled");
										}
									});
									//将验证码发送给手机号
									$("#code1").click(function(){														
										...
										$.post("UserFrontServlet",{method:"userPhoneCode"},function(data){
											var code1 = data;
											if(code1==2)
											{}
											else
											{
											  $("#code3span").attr("class",code1);
										      $.post("UserFrontServlet",{method:"userPhoneFindbyName",tel1:tel1},function(data){
											      var num = data;
											          if (num==1) {
									...
									//验证码验证
									$("#code3").blur(function(){
										var code = $("#code3span").attr("class");
										var code1 = $("#code3").val();
										if (code==code1&&code1!=""&&code1!=null&&code1!=" ") {
											$("#register1").removeAttr("disabled");
											$("#code3span").html("<img src='/FlowerShop1.0/images/check.png' style='width: 25px'/>验证码正确");
										} else{
											$("#register1").attr("disabled","disabled");
											$("#code3span").html("<img src='/FlowerShop1.0/images/close.png' style='width: 25px'/>验证码错误");
										} 
									});
		...
		<form action="UserFrontServlet?method=userUpdatePhone" method="post"> 
              <div class="">手机号：
                <input type="text" class="textBox length-middle"
					id="tel1" name="tel" style="width:300px;"/><span id="tel1span" style="width:200px"></span>
			  ...
			  <div class="">验证码：
                <input type="text" class="textBox length-middle"
					id="code3" style="width:300px;"/><span id="code3span"></span>
			
			  </div>
              <br>
               
              <div>
              <input type="button" class="acount-btn" id="code1" value="发送验证码" 
              ...
              <input type="submit" class="acount-btn" id="register1" value="提交" 
              style="outline:none;border:none;background:rgb(82,208,196);padding:8px 0;color:#fff;width:12%;height:5.5%;font-size:1em;text-transform:uppercase;margin:2em 0 0;"
			  disabled="disabled"/>
              </div>
