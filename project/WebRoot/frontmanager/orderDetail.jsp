										...
										<div class="kd-popup pop-back" style="margin-bottom: 40px;">
											<div class="box">
												<div class="bd">
                                                  ...
                                                  <a id="J_Go" class="btn-go"  title="点击此按钮，立即支付。" href="${pageContext.request.contextPath}/OrderFrontServlet?method=userupdateorder&orderstate=2&oid=${oid}">立即支付<b class="dpl-button"></b></a>
                                                  </c:if>
										</div>
									</div>
