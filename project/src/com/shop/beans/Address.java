...
public class Address {
	...
	public Address(Integer add_id, Integer u_id, String address,
			String postcode, String consignee_name, String consignee_tel,
			Integer add_del, String add_memo) {
		super();
		this.add_id = add_id;
		this.u_id = u_id;
	...
	public String toString() {
		return "Address [add_id=" + add_id + ", u_id=" + u_id + ", address="
				...
				+ ", add_del=" + add_del + ", add_memo=" + add_memo + "]";
	}
